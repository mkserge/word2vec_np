...
def main():
    ...
    dict_file_1 = '../data-out/2018-03-07/run6/mine/dictionary.txt'
    w1_file_1 = '../data-out/2018-03-07/run6/mine/w1.npy'

    # Dictionary and the embeddings for run #2
    dict_file_2 = '../data-out/2018-03-07/run6/w2v/dictionary.txt'
    w1_file_2 = '../data-out/2018-03-07/run6/w2v/w1.txt'

    dict_1 = [line.rstrip('\n') for line in open(dict_file_1)]
    W1_1 = np.load(w1_file_1)

    dict_2 = [line.rstrip('\n') for line in open(dict_file_2)]
    W1_2 = np.loadtxt(w1_file_2)

    # Drop the first and second rows of W1 cause it is a dummy for the 'PAD' and 'UNK' symbols
